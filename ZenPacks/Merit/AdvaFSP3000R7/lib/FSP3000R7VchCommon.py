...
__doc__="""FSP3000R7VchCommon

FSP3000R7VchCommon provides a base for mapping Virtual Channels on a FSP3000R7 system
...
class FSP3000R7VchCommon(FSP3000R7MibCommon):

    # The component class to be modeled, i.e. 'ZenPacks.Merit.AdvaFSP3000R7.FSP3000R7Vch'
    modname = "Not set by modeler subclass"
    # The relationship name of the component to the parent device, i.e. 'FSP3000R7VchRel'
    relname = "Not set by modeler subclass"
